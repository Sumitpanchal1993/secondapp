        ...
        <div className='center my-3'>
          <div className='card mx-3' style={{ width: '20rem' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: 'black' }}>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus, placeat id magni blanditiis iste ipsam minima, maxime magnam porro suscipit ut temporibus, cupiditate aspernatur recusandae dolorem sapiente veritatis? Sit, expedita.</p>
